...
@interface FBRequest : NSObject {
	...
	id<FBServiceResultDelegate> _del;
	FBQueriesTypes				_query;
}


@property(nonatomic,assign) id<FBRequestDelegate> delegate;

@property(nonatomic,assign) id<FBServiceResultDelegate> del;
@property(nonatomic,assign) FBQueriesTypes query;
/**
...
- (void)request:(FBRequest *)request didLoad:(id)result withFBResultDelegate:(id<FBServiceResultDelegate>) del;
/**
