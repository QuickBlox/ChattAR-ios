...
// private methods
- (void)didReceiveRequestForSessionFrom:(NSString*)jid;
- (void)receivedAcceptForSessionFrom:(NSString*)jid;
- (void)receivedRejectForSessionFrom:(NSString*)jid;
- (void)didReceiveData:(NSData*)data;
- (void)dataWasSendedSuccessfully;

- (void)didReceiveIP:(NSString*)IP andPort:(int)port;
